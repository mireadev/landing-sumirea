document.addEventListener('DOMContentLoaded', function () {
    ...
    var fireworks = (function () {
        ...
        var colors = ['#CD2027', '#32459D', '#F3EC1C'];
        ...
        var animateParticules = function (x, y) {
            ...
            var circleAnimation = anime({
                ...
                alpha: {
                    ...
                    easing: 'linear',
                    duration: function () {
                        return anime.random(600, 800);
                    }
                },
                duration: function () {
                    return anime.random(1800, 2400);
                },
                easing: 'easeOutExpo',
                complete: removeAnimation
            });
        ...
        var anim_div = document.getElementById('first');

        var onClick = function (e) {
            if (e.type === 'touchstart') {
                anim_div.removeEventListener('mousedown', onClick, false);
                anim_div.addEventListener('mousedown', restoreMouse, false);
            }
            updateCoords(e);
        ...
        var restoreMouse = function (e) {
            onClick(e);
            anim_div.addEventListener('mousedown', onClick, false);
        }

        anim_div.addEventListener('touchstart', onClick, false);
        anim_div.addEventListener('mousedown', onClick, false);

        window.addEventListener('resize', setCanvasSize, false);

        //add animation on page loading
        function increasingTimeout(i) {
            setTimeout(function() {
                randomAnimate();
            }, 500 + i * 150);
        }
        ...
        var logo = document.getElementById('su_logo');
        ...
        function randomAnimate() {
            var e = {};
            e.clientX = logo.offsetLeft + getRandomInt(-200, 200);
            e.clientY = logo.offsetTop + getRandomInt(-200, 200);
            updateCoords(e);
            animateParticules(x, y);
        }
